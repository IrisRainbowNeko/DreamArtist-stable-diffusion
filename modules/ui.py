...
import modules.dream_artist.ui
...
def create_ui(wrap_gradio_gpu_call):
    ...
    with gr.Blocks(analytics_enabled=False) as train_interface:
            ...
            with gr.Tabs(elem_id="train_tabs"):
                ...
                with gr.Tab(label="Train"):
                    ...
                    with gr.Row():
                        ...
                        create_refresh_button(train_embedding_name, sd_hijack.model_hijack.embedding_db.load_words_embeddings, lambda: {"choices": sorted(sd_hijack.model_hijack.embedding_db.word_embeddings.keys())}, "refresh_train_embedding_name")
                    with gr.Row():
        ...
        create_embedding.click(
            fn=modules.dream_artist.ui.create_embedding,
            inputs=[
                new_embedding_name,
                initialization_text,
                nvpt,
        ...
        run_preprocess.click(
            fn=wrap_gradio_gpu_call(modules.dream_artist.ui.preprocess, extra_outputs=[gr.update()]),
        ...
        train_embedding.click(
            fn=wrap_gradio_gpu_call(modules.dream_artist.ui.train_embedding, extra_outputs=[gr.update()]),
            _js="start_training_textual_inversion",
            inputs=[
                train_embedding_name,
